                    ...
                    <tbody>
                        <?php foreach ($top_posts as $post_item) : ?>
                            <tr>
                                ...
                                <td><?php echo esc_html(number_format_i18n($post_item['count'])); ?></td>
                                <td>
                                    <?php if (!empty($post_item['edit_url'])) : ?>
                                        <a class="gd-audit__link" href="<?php echo esc_url($post_item['edit_url']); ?>"><?php esc_html_e('Edit', 'gd-audit'); ?></a>
                                    <?php endif; ?>
                                    <?php if (!empty($post_item['view_url'])) : ?>
                                        <span> | </span>
                                        <a class="gd-audit__link" href="<?php echo esc_url($post_item['view_url']); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e('View', 'gd-audit'); ?></a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    ...
                    <tbody>
                        <?php foreach ($top_domains as $domain) : ?>
                            <tr>
                                ...
                                <td><?php echo esc_html(number_format_i18n($domain['count'])); ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
