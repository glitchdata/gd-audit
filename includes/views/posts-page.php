...
?>
<div class="wrap gd-audit gd-audit-posts">
    <?php include GD_AUDIT_PLUGIN_DIR . 'includes/views/partials/nav-tabs.php'; ?>

    <h1 class="gd-audit__section-title"><?php esc_html_e('Posts', 'gd-audit'); ?></h1>
    <p class="gd-audit-dashboard__lead">
        <?php esc_html_e('Track publishing velocity, author impact, and the state of recent content.', 'gd-audit'); ?>
    </p>
    ...
    <div class="gd-audit__panels">
                ...
                <ul class="gd-audit__sparkline">
                    <?php foreach ($daily_activity as $point) : ?>
                        <li>
                            ...
                            <strong><?php echo esc_html(number_format_i18n($point['total'])); ?></strong>
                        </li>
                    <?php endforeach; ?>
                </ul>
            <?php else : ?>
                <p><?php esc_html_e('No recent publishing activity detected.', 'gd-audit'); ?></p>
            <?php endif; ?>
        </section>
        ...
        <section class="gd-audit__panel">
            ...
            <?php else : ?>
                <p><?php esc_html_e('Not enough author activity for this window.', 'gd-audit'); ?></p>
            <?php endif; ?>
        </section>
    </div>
    ...
    <div class="gd-audit__panels">
        <section class="gd-audit__panel">
            ...
            <?php else : ?>
                <p><?php esc_html_e('No recent posts to show.', 'gd-audit'); ?></p>
            <?php endif; ?>
        </section>
    </div>
</div>
